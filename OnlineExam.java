...
class OnlineTest extends JFrame implements ActionListener
{
    ...
    void set()
    {
        ...
        if(current==0)
        {
            l.setText("Que1: Expected created by try block is caaught in which block.?");
            jb[0].setText("catch");jb[1].setText("throw");jb[2].setText("final");jb[3].setText("thrown");
        }
        if(current==1)
        {
            l.setText("Que2: Identify the infinite loop?");
        ...
        if(current==3)
        {
            l.setText("Que4: Number of primitive data types in java are?");
            jb[0].setText("6");jb[1].setText("7");jb[2].setText("8");jb[3].setText("9");

        }
        if(current==4) {
            l.setText("Que5: Who is known as father of java programming language?");
            jb[0].setText("charles Babbage");jb[1].setText("James Gosling");jb[2].setText("M.P.Java");jb[3].setText("Blais Pascal");
        }
        if(current==5)
        {
            l.setText("Que6: Which of the following is not an OOPS concept in java?");
